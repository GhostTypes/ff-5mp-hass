# Source: https://developers.home-assistant.io/docs/supervisor/development
...
The instructions here is for development of the `hassio` integration, we're going to assume that you have a [Home Assistant Core development environment](/docs/development_environment) set up, and that you have [Supervisor API Access](#supervisor-api-access) set up.
...
The instructions here is for development of the Supervisor panel, we're going to assume that you have a [Home Assistant frontend development environment](/docs/frontend/development) set up with the devcontainer, and that you have [Supervisor API Access](#supervisor-api-access) set up.
