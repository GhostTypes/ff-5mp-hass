# Source: https://developers.home-assistant.io/docs/device_automation_trigger
...
This is a voluptuous schema that verifies that a specific trigger dictionary represents a config that your integration can handle. This should extend the TRIGGER\_BASE\_SCHEMA from `device_automation/__init__.py`.
...
For example, you might attach the trigger and action to [Events fired](/docs/integration_events) on the event bus by your integration.
