# Source: https://developers.home-assistant.io/docs/auth_index
...
This is the permission policy that describes to which resources a group has access. For more information about permissions and policies, see [Permissions](/docs/auth_permissions).
