# Source: https://developers.home-assistant.io/docs/auth_auth_module
...
For an example of a fully implemented auth module, please see [insecure\_example.py](https://github.com/home-assistant/core/blob/dev/homeassistant/auth/mfa_modules/insecure_example.py).
...
| `async def async_validate(self, user_id, user_input)` | Yes | Given a user\_id and user input, return validation result. |
...
* TOTP module saved the secret along with user\_id, module is enabled for user
