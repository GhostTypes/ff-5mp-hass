# Source: https://developers.home-assistant.io/docs/core/entity/calendar
...
| recurrence\_id | string | `None` | An optional identifier for a specific instance of a recurring event (required for mutations of recurring events) |
