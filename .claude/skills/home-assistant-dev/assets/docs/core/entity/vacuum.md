# Source: https://developers.home-assistant.io/docs/core/entity/vacuum
...
| --- | --- | --- | --- |
| fan\_speed | string | `none` | The current fan speed. |
| fan\_speed\_list | list | `NotImplementedError()` | List of available fan speeds. |
