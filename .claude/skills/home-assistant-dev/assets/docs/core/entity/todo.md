# Source: https://developers.home-assistant.io/docs/core/entity/todo
...
| --- | --- | --- | --- |
| todo\_items | `list[TodoItem] | None` | `None` | **Required.** The ordered contents of the To-do list. |
...
| description | `string | None` | `None` | A more complete description of the to-do item than that provided by the summary. |
