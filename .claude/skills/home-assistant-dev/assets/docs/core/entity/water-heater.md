# Source: https://developers.home-assistant.io/docs/core/entity/water-heater
...
The allowed operation modes are the states specified in the base component and implementations of the water\_heater component cannot differ.
...
Sets the operation mode of the water heater. Must be in the operation\_list.
