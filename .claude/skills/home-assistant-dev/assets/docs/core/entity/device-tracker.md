# Source: https://developers.home-assistant.io/docs/core/entity/device-tracker
...
| --- | --- | --- | --- |
| battery\_level | `int | None` | `None` | The battery level of the device. |
| hostname | `str | None` | `None` | The hostname of the device. |
| ip\_address | `str | None` | `None` | The IP address of the device. |
| is\_connected | `bool` | **Required** | The connection state of the device. |
| mac\_address | `str | None` | `None` | The MAC address of the device. |
| source\_type | `SourceType` | `SourceType.ROUTER` | The source type of the device. |
...
| location\_accuracy | `float` | `0` | The location accuracy (m) of the device. |
| location\_name | `str | None` | `None` | The location name of the device. |
| longitude | `float | None` | `None` | The longitude coordinate of the device. |
| source\_type | SourceType | `SourceType.GPS` | The source type of the device. |