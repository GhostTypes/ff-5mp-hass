# Source: https://developers.home-assistant.io/docs/core/entity/text
...
| native\_max | int | 100 | The maximum number of characters in the text value (inclusive). |
| native\_min | int | 0 | The minimum number of characters in the text value (inclusive). |
| pattern | str | `None` | A regex pattern that the text value must match to be valid. |
| native\_value | str | **Required** | The value of the text. |
