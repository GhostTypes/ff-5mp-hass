# Source: https://developers.home-assistant.io/docs/core/entity/tts
...
| --- | --- | --- | --- |
| supported\_languages | list[str] | **Required** | The supported languages of the TTS service. |
| default\_language | str | **Required** | The default language of the TTS service. |
| supported\_options | list[str] | None | The supported options like voice, emotions of the TTS service. |
| default\_options | Mapping[str, Any] | None | The default options of the TTS service. |
