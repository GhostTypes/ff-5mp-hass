# Source: https://developers.home-assistant.io/docs/core/entity/remote
...
| --- | --- | --- | --- |
| is\_on | boolean | `None` | If the device is currently on or off. |
| current\_activity | str | `None` | Return the current active activity. |
| activity\_list | list | `None` | Return the list of available activities. |
