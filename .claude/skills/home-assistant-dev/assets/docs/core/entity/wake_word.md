# Source: https://developers.home-assistant.io/docs/core/entity/wake_word
...
| --- | --- | --- | --- |
| supported\_wake\_words | list[WakeWord] | **Required** | The supported wake words of the service with:  * ww\_id - unique identifier * name - human-readable name |
