# Source: https://developers.home-assistant.io/docs/core/entity/datetime
...
| --- | --- | --- | --- |
| native\_value | `datetime.datetime | None` | **Required** | The value of the datetime. Must include timezone info. |
