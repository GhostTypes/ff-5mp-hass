# Source: https://developers.home-assistant.io/docs/architecture/devices-and-services
...
![Integrating devices & services](/img/en/architecture/integrating-devices-services.svg)

Configuration is provided by the user via a [Config Entry](/docs/config_entries_index) or in special/legacy cases via [configuration.yaml](/docs/configuration_yaml_index).
...
![Entities interacting with core](/img/en/architecture/entity-core-interaction.svg)
...
![Entity hierarchy](/img/en/architecture/entity-data-hierarchy.svg)
