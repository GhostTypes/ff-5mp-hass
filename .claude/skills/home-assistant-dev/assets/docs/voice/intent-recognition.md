# Source: https://developers.home-assistant.io/docs/voice/intent-recognition
...
In Home Assistant we are collecting our sentence templates [on GitHub](https://github.com/home-assistant/intents). The repository aims to contain for each language and each [supported intent in Home Assistant](/docs/intent_builtin), the possible sentences a user might say.