# Source: https://developers.home-assistant.io/docs/voice/intent-recognition/contributing
...
If you are unable to run the add\_language script locally, ask in Discord to have a maintainer run it for you.