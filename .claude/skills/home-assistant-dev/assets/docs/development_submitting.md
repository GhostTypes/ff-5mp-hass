...
2. Make your changes, create a [new platform](/docs/creating_platform_index), develop a [new integration](/docs/creating_component_index), or fix [issues](https://github.com/home-assistant/core/issues).
3. [Test your changes](/docs/development_testing) and check for style violations.
   Consider adding tests to ensure that your code works.
4. If everything looks good according to these [musts](/docs/development_checklist), commit your changes:
