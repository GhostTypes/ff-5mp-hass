# Source: https://developers.home-assistant.io/docs/api/native-app-integration/sending-data
...
For available keys and response, see the [conversation API documentation](/docs/intent_conversation_api).