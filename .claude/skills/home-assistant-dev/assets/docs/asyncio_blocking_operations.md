# Source: https://developers.home-assistant.io/docs/asyncio_blocking_operations
...
See [Importing code with asyncio](/docs/asyncio_imports)
...
See [SSLContext.load\_default\_certs](#load_default_certs)
