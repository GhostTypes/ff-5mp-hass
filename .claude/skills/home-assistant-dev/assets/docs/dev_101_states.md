# Source: https://developers.home-assistant.io/docs/dev_101_states
...
This is a simple tutorial/example on how to create and set states. We will do our work in a component called "hello\_state". The purpose of this component is to display a given text in the frontend.
...
![](/img/en/development/create-component01.png)
...
To get your integration included in the Home Assistant releases, follow the steps described in the [Submit your work](/docs/development_submitting) section. Basically you only need to move your integration into the `homeassistant/component/` directory of your fork and create a Pull Request.