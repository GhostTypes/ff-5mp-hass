...
If you don't want to use the devcontainer environment, you can still build add-ons locally with Docker. The recommended method is to use the [official build tool](https://github.com/home-assistant/builder) to create the Docker images.
