# Source: https://developers.home-assistant.io/docs/documenting/integration-docs-examples
...
* The integration documentation template in the home-assistant.io repository under [/\_integrations/\_integration\_docs\_template.markdown](https://github.com/home-assistant/home-assistant.io/tree/current/source/_integrations/_integration_docs_template.markdown).
...
![Screenshot showing the styling of my links](/img/en/documentation/my-links_formatting.png)
...
![Screenshot showing the styling of a glossary term tooltip](/img/en/documentation/glossary-term_tooltip.png)
...
![Screenshot showing the styling of an abbreviation tooltip](/img/en/documentation/abbreviation_tooltip.png)
...
![Screenshot showing some inline icons](/img/en/documentation/inline_icons.png)
...
![Screenshot showing a collapsible text block](/img/en/documentation/collapsible_text_block.webp)
...
![Screenshot showing text boxes](/img/en/documentation/text_boxes.png)
...
![Screenshot showing predefined configuration text block](/img/en/documentation/config_flow.png)
...
#### Configuration\_basic block

Use the `configuration_basic` block to describe configuration options if your integration is set up via a config flow.

![Screenshot showing a configuration variable block for integrations that are set up in the UI](/img/en/documentation/configuration_variables_ui.png)
...
![Screenshot showing a configuration variable block for YAML integrations](/img/en/documentation/configuration_variables_yaml.png)
...
![Screenshot showing an image to illustrate a step](/img/en/documentation/image_in_step.png)
...
![Screenshot showing an image with an image caption](/img/en/documentation/image_with_legend.png)
...
![Screencast showing a reference to Youtube to start at a specific time](/img/en/documentation/youtube_ref_start_at.webp)
