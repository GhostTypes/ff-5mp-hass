# Source: https://developers.home-assistant.io/docs/documenting/create-page
...
3. Make sure to follow the [Standards](/docs/documenting/standards) we have for the documentation, including:
...
For the [configuration templating](https://www.home-assistant.io/docs/configuration/templating/) [Jinja](http://jinja.pocoo.org/) is used. Check the [Documentation Standards](/docs/documenting/standards) for further details.
