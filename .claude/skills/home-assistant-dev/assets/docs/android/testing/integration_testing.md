# Source: https://developers.home-assistant.io/docs/android/testing/integration_testing
...
If your tests require the WebView, you may need to follow these [tips for the Lollipop emulator](/docs/android/tips/lollipop_emulator).