# Source: https://developers.home-assistant.io/docs/android/ci
...
We follow the same versioning convention as the core project, using [CalVer](https://calver.org/) (Calendar Versioning). This ensures consistency across all releases.
...
On the first day of every month, the `monthly.yml` workflow runs to create an initial version tag in the format `YYYY.MM.0`. This aligns with our [CalVer](https://calver.org/) versioning strategy.
