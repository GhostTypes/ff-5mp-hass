# Source: https://developers.home-assistant.io/docs/android/codestyle
...
If a KTLint error is detected, the CI will fail, and GitHub will report it as a comment in the PR using the generated [SARIF](/docs/android/tips/sarif_reports) report.
