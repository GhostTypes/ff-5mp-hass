# Source: https://developers.home-assistant.io/docs/api_lib_auth

This page is intended for general API development of a 3rd party library aiming to integrate a 3rd party API. See [Home Assistant REST API documentation](/docs/api/rest) for interacting with Home Assistant's API.
