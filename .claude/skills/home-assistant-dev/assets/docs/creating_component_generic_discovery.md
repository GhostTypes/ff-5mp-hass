# Source: https://developers.home-assistant.io/docs/creating_component_generic_discovery
...
If your integration is set up via a config entry, you will need to forward the config entry to the appropriate integration to set up your platform. For more info, see the [config entry documentation](/docs/config_entries_index#for-platforms).
