...
Before you start, make sure that you have read up on the overall [Home Assistant architecture](/docs/architecture_index) so that you are familiar with the concepts that make up Home Assistant.
