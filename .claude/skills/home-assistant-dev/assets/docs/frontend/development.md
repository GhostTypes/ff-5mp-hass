...
The first step is to fork the [frontend repository](https://github.com/home-assistant/frontend) and add the upstream remote. You can place the forked repository anywhere on your system.
...
You will need to have an instance of Home Assistant set up. For a development instance see our guide on [setting up a development environment](/docs/development_environment).
...
![](/img/en/development/disable-cache.png)

2. Enable Bypass for network in **Application** > **Service Workers** > **Bypass for network**

![](/img/en/development/bypass-for-network.png)
