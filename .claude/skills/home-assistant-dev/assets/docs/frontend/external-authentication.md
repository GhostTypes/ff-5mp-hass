...
When the user presses the logout button on the profile page, the external app will have to [revoke the refresh token](/docs/auth_api#revoking-a-refresh-token), and log the user out.
