...
Strategies are defined as a custom element in a JavaScript file, and included [via dashboard resources](/docs/frontend/custom-ui/registering-resources). Home Assistant will call static functions on the class instead of rendering it as a custom element.
