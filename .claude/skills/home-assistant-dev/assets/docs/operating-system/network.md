# Source: https://developers.home-assistant.io/docs/operating-system/network
...
[Configuration](/docs/operating-system/configuration).
...
You can read the [NetworkManager manual](https://networkmanager.dev/docs/api/1.40/manpages.html) or find many configuration
...
every boot, you should modify the UUID property to a generic [UUID4](https://www.uuidgenerator.net/version4).
