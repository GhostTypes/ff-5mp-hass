...
3. Each requirement meets the [library requirements](/docs/api_lib_index#basic-library-requirements).

### 2. Configuration

1. Voluptuous schema present for [configuration validation](/docs/development_validation)
