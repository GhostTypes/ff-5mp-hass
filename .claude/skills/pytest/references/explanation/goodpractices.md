...
`pip:index` for installing your application and any dependencies,
as well as the `pytest` package itself.
This ensures your code and dependencies are isolated from your system Python installation.

Create a `pyproject.toml` file in the root of your repository as described in
`packaging:tutorials/packaging-projects`.
...
For historical reasons, pytest defaults to the `prepend` `import mode`
...
see the [pytest-runner notice](https://github.com/pytest-dev/pytest-runner#deprecation-notice).
See also [pypa/setuptools#1684](https://github.com/pypa/setuptools/issues/1684).

setuptools intends to
[remove the test command](https://github.com/pypa/setuptools/issues/931).

## Checking with flake8-pytest-style

In order to ensure that pytest is being used correctly in your project,
it can be helpful to use the [flake8-pytest-style](https://github.com/m-burst/flake8-pytest-style) flake8 plugin.
