...
from collection. Refer to `customizing-test-collection` for more
information.

## Skipping on a missing import dependency

You can skip tests on a missing import by using `pytest.importorskip ref`
