...
- :py`pytest.fixture()` allows one to :ref:`parametrize fixture
...
The builtin `pytest.mark.parametrize ref` decorator enables
...
(see `mark`) which would invoke several functions with the argument sets,
for instance:
