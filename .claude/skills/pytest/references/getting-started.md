...
For example, you can use `pytest.approx()` to compare floating-point
...
`pytest` provides :std`Builtin fixtures/function arguments` to request arbitrary resources, like a unique temporary directory:
